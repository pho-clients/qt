...
SWGUUID*
SWGInline_response_200_2::getId() {
    return id;
}
void
SWGInline_response_200_2::setId(SWGUUID* id) {
    this->id = id;
}

QString*
SWGInline_response_200_2::getClass() {
    return class;
}
void
SWGInline_response_200_2::setClass(QString* class) {
    this->class = class;
}
