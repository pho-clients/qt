...
SWGUUID*
SWGInline_response_200_1::getId() {
    return id;
}
void
SWGInline_response_200_1::setId(SWGUUID* id) {
    this->id = id;
}

QString*
SWGInline_response_200_1::getClass() {
    return class;
}
void
SWGInline_response_200_1::setClass(QString* class) {
    this->class = class;
}
